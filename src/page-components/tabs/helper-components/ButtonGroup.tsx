...
const ButtonGroup: React.FC<ButtonGroupProps> = ({
  ...
  return (
    <ButtonGroupWrapper>
      ...
      <Menu anchorEl={anchorElExport} open={Boolean(anchorElExport)} onClose={onExportClose}>
        <MenuList>
      ...
      >
        <MenuList>
          <MenuItem onClick={handleColumnClose} style={{ display: "flex", alignItems: "center", gap: "10px" }}>
            <FaCheck /> Name
          </MenuItem>
          <MenuItem onClick={handleColumnClose} style={{ display: "flex", alignItems: "center", gap: "10px" }}>
            <FaCheck /> Image
