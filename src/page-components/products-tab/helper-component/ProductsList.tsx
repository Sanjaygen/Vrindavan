...
import { Button, ButtonsContainer, FormColumn, FormContainer, FormRow, HelperText, ImagePreview, Input, InputContainer, Label, RemoveLink, SecondaryButton, StyledButton, StyledHr, UploadArea, UploadIcon, UploadText } from "@/page-components/categories-tabs/helper-component/CategoriesList.styled";
